...
# TODO здесь ваш код
song_halo=violator_songs_list[3]
song_enjoy_the_silence=violator_songs_list[5]
song_clean=violator_songs_list[8]
sound_duration=song_halo[1]+song_clean[1]+song_enjoy_the_silence[1]
print('Три песни звучат ',sound_duration,'минут')
