...
# Тут ошибка. Если в дебаге оставить точку на принте, то видно, что значение educational_grant_year = 90000,
# а должно быть 100000. Ответ при этом тоже должне быть иным 37566,55, если я не ошибся.
